  ...
  <?php 
    ...
    for ($row=1; $row<=3; $row++) {
      ...
      for ($column=1; $column<=4; $column++) {
        ...
        echo '<tr class="days">
              <td class="p-2 text-center border-b-2">Seg</td>
              <td class="p-2 text-center border-b-2">Ter</td>
              <td class="p-2 text-center border-b-2">Qua</td>
              <td class="p-2 text-center border-b-2">Qui</td>
              <td class="p-2 text-center border-b-2">Sex</td>';
        echo '<td class="p-2 text-center border-b-2">Sab</td>
              <td class="p-2 text-center border-b-2 text-red-500">Dom</td>
              </tr>';
        echo '<tr>';
